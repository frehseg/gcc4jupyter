...
linker_option = '-lm'
compiler_option1 = '-Wall'
compiler_option2 = '-Werror'
compiler_option3 = '-Wfatal-errors'
ext = '.c'
    ...
    def c(self, line, cell):
        ...
        with tempfile.TemporaryDirectory() as tmp_dir:
            ...
            with open(file_path + ext, "w") as f:
                f.write(cell)
            try:
                subprocess.check_output([compiler, file_path + ext, "-o", file_path + ".out", compiler_option1, compiler_option2, compiler_option3, linker_option], stderr=subprocess.STDOUT)
